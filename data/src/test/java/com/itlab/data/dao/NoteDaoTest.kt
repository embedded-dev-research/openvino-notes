...
class NoteDaoTest {
    ...
    @Test
    fun `insert and getNoteById should return correct note`() = runTest {
    ...
    @Test 
    fun `delete should remove note from database`() = runTest {
    ...
    @Test
    fun `getAllNotes should return notes ordered by updatedAt descending`() = runTest {
    ...
    @Test 
    fun `insertAll should save multiple notes and replace on conflict`() = runTest {
    ...
    @Test 
    fun `getUnsyncedNotes should only return notes where isSynced is false`() = runTest {
