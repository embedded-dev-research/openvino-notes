...
import com.itlab.domain.usecase.*
...
class FolderUseCasesTest {
    ...
    @Test
    fun createFolder_and_getFolder() = runBlocking {
    ...
    @Test
    fun updateFolder_works() = runBlocking {
        val repo = FakeFolderRepo()
    ...
    @Test
    fun deleteFolder_works() = runBlocking {
        val repo = FakeFolderRepo()
    ...
    @Test
    fun observeFolders_emitsData() = runBlocking {
        val repo = FakeFolderRepo()
        val create = CreateFolderUseCase(repo)
